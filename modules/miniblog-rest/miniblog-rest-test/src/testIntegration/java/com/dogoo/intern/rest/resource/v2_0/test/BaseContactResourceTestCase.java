...
import com.dogoo.intern.rest.client.resource.v2_0.ContactResource;
...
public abstract class BaseContactResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		Assert.assertEquals(regex, contact.getMessage());
		Assert.assertEquals(regex, contact.getName());
	}

	@Test
	public void testGetContacts() throws Exception {
		Page<Contact> page = contactResource.getContacts();

		long totalCount = page.getTotalCount();

		Contact contact1 = testGetContacts_addContact(randomContact());

		Contact contact2 = testGetContacts_addContact(randomContact());

		page = contactResource.getContacts();
	...
	protected Contact testGetContacts_addContact(Contact contact)
		throws Exception {
	...
	@Test
	public void testGraphQLGetContacts() throws Exception {
	...
	public void testAddContact() throws Exception {
		...
		Contact postContact = testAddContact_addContact(randomContact);

		assertEquals(randomContact, postContact);
		assertValid(postContact);
	}

	protected Contact testAddContact_addContact(Contact contact)
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.dogoo.intern.rest.dto.v2_0.Contact.class)) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("message")) {
			sb.append("'");
			sb.append(String.valueOf(contact.getMessage()));
			sb.append("'");
	...
	@Inject
	private com.dogoo.intern.rest.resource.v2_0.ContactResource
		_contactResource;
