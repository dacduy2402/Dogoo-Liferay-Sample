...
public interface ContactResource {
	...
	public HttpInvoker.HttpResponse getContactsHttpResponse() throws Exception;

	public Contact addContact(Contact contact) throws Exception;

	public HttpInvoker.HttpResponse addContactHttpResponse(Contact contact)
		throws Exception;
	...
	public static class ContactResourceImpl implements ContactResource {
		...
		public Page<Contact> getContacts() throws Exception {
			HttpInvoker.HttpResponse httpResponse = getContactsHttpResponse();
		...
		public HttpInvoker.HttpResponse getContactsHttpResponse()
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/miniblog-rest/v2.0/contacts");
		...
		public Contact addContact(Contact contact) throws Exception {
			HttpInvoker.HttpResponse httpResponse = addContactHttpResponse(
				contact);
