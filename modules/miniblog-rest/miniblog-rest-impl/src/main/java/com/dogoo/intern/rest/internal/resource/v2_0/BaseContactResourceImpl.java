...
public abstract class BaseContactResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/miniblog-rest/v2.0/contacts'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(description = "Get all contact")
	...
	@Override
	public Page<Contact> getContacts() throws Exception {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/miniblog-rest/v2.0/contacts' -d $'{"email": ___, "message": ___, "name": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
