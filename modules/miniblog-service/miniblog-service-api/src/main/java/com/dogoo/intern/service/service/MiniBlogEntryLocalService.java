...
/**
 * Provides the local service interface for MiniBlogEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MiniBlogEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MiniBlogEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.intern.service.service.impl.MiniBlogEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mini blog entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MiniBlogEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public void mapMiniBlogData(
		MiniBlogEntry miniBlogEntry, MiniblogEntryMapper miniblogEntryMapper);

	public MiniBlogEntry updateMiniBlogById(
			Long id, MiniblogEntryMapper miniBlogMapper)
		throws PortalException;
