...
/**
 * The persistence interface for the mini blog entry service.
 *
 * <p>
 ...
 * @see MiniBlogEntryUtil
 * @generated
 */
@ProviderType
public interface MiniBlogEntryPersistence
	extends BasePersistence<MiniBlogEntry> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MiniBlogEntryUtil} to access the mini blog entry persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<MiniBlogEntry> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<MiniBlogEntry> findByUuid(
	...
	public java.util.List<MiniBlogEntry> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MiniBlogEntry>
			orderByComparator);
	 ...
	 * @return the matching mini blog entries
	 */
	public java.util.List<MiniBlogEntry> findByUuid_C(
	 ...
	 */
	public void cacheResult(java.util.List<MiniBlogEntry> miniBlogEntries);
	 ...
	 */
	public java.util.List<MiniBlogEntry> findAll();
	 ...
	 */
	public java.util.List<MiniBlogEntry> findAll(int start, int end);
